...
var ASM_CONSTS = {
 ...
 94546: () => { return window.devicePixelRatio; },  
 94582: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 94635: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 94706: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 94763: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 95019: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 95090: () => { if (document.fullscreenElement) return 1; },  
 95136: () => { return window.innerWidth; },  
 95162: () => { return window.innerHeight; },  
 95189: () => { if (document.pointerLockElement) return 1; }
};
